...
pgj[pgj$subtipo == "LESIONES DOLOSAS" &
      pgj$modalidad == "CON ARMA DE FUEGO",]$crime  <-  'LESIONES POR ARMA DE FUEGO'
pgj[pgj$subtipo == "ROBO DE VEHÍCULO AUTOMOTOR" &
      pgj$modalidad == "ROBO DE COCHE DE 4 RUEDAS CON VIOLENCIA",]$crime  <-  'ROBO DE VEHICULO AUTOMOTOR C.V.'
pgj[pgj$subtipo == "ROBO DE VEHÍCULO AUTOMOTOR" &
      pgj$modalidad == "ROBO DE MOTOCICLETA CON VIOLENCIA",]$crime  <-  'ROBO DE VEHICULO AUTOMOTOR C.V.'
pgj[pgj$subtipo == "ROBO DE VEHÍCULO AUTOMOTOR" &
      pgj$modalidad == "ROBO DE COCHE DE 4 RUEDAS SIN VIOLENCIA",]$crime  <-  'ROBO DE VEHICULO AUTOMOTOR S.V.'
pgj[pgj$subtipo == "ROBO DE VEHÍCULO AUTOMOTOR" &
      pgj$modalidad == "ROBO DE MOTOCICLETA SIN VIOLENCIA",]$crime  <-  'ROBO DE VEHICULO AUTOMOTOR S.V.'
